...
TextureHandle::TextureHandle(int id) : _id(id)
{
    std::cout << "[alloc] texture #" << _id << "\n";
}
...
TextureHandle::TextureHandle(TextureHandle&& other) noexcept : _id(other._id)
{
