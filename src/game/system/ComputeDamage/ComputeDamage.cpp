...
float game::system::ComputeDamage(float base, DamageType type)
{
    switch (type)
    {
    case DamageType::Hitscan: return base * HITSCAN_MULT;
    case DamageType::Projectile: return base * PROJECTILE_MULT;
    case DamageType::Explosion: return base * EXPLOSION_MULT;
    case DamageType::Environment: return base * ENVIRONMENT_MULT;
    }
    return base;
}

float game::system::ComputeDamage(float base, DamageType type, float distance, float falloff)
{
